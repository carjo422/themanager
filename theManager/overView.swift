...
class overView: modScene {
    ...
    override func didMove(to view: SKView) {
        ...
        for i in 1...8 {
            createLink(xK: 0.0, yK: 0.8-CGFloat(j)*0.5-CGFloat(i)*0.05, w: 0.5, h: 0.05, bgColor: UIColor.white, linkText: String(describing: GameScene.series[j].teams[i].teamName), image: "", id: GameScene.series[0].teams[i].id, addNode: seriesNode, src: "T"+String(GameScene.series[j].teams[i].id))
        }
